...
public enum CommandType {		
	...
	/** pattern */
	CALL_COMPLETER_PATTERN, CALL_MIXIN_PATTERN, CALL_MIXIN_WITH_SUBKIND_PATTERN,
	CALL_PHASE_PARTITION_PATTERN, CALL_SUBKIND_PARTITION_PATTERN, CALL_ROLE_PARTITION_PATTERN,
	CALL_ROLEMIXIN_PATTERN, CALL_RELATOR_PATTERN, CALL_DEPENDENT_ROLEMIXIN_PATTERN,
	CALL_GENERIC_RELATOR_PATTERN, CALL_CHARACTERIZATION_PATTERN, CALL_RIGID_WS_PATTERN,
	CALL_ANTIRIGID_WS_PATTERN, CALL_KIND_PARTITION_PATTERN, CALL_QUANTITY_PARTITION_PATTERN,
	CALL_COLLECTIVE_PARTITION_PATTERN, CALL_CATEGORY_PATTERN,
	
	/** domain pattern */
	CALL_DOMAIN_PATTERN,
	
	/** derived pattern */
	CALL_UNION_PATTERN, CALL_EXCLUSION_PATTERN, 
	CALL_INTERSECTION_PATTERN, CALL_SPECIALIZATION_PATTERN, 
	CALL_PASTSPECIALIZATION_PATTERN, CALL_PARTICIPATION_PATTERN;
