...
public class AttributeMappingPane extends JPanel {
	
	private static final long serialVersionUID = -7587547341203464118L;

	private JScrollPane scrollpane = new JScrollPane();
	private JTable table = new JTable();
	private AttributeMappingTableModel tableModel;
	...
	public AttributeMappingTableModel getTableModel()
	{
		return tableModel;
	}
	
	public AttributeMappingPane(String sourceLanguage, OntoUMLParser refparser, String targetLanguage, String[] targetPrimitiveOptions)
	{
		tableModel = new AttributeMappingTableModel(sourceLanguage, targetLanguage);
		...
		{
			if(pt.getAssociation()==null && pt.getType()!=null) sourcePrimitiveOptions.add(pt.getName()+": "+pt.getType().getName());
		}
