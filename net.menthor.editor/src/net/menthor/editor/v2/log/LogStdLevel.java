 ...
 */
public class LogStdLevel extends Level {
    
	private static final long serialVersionUID = 2077412803849509367L;

	/** Level for STDOUT activity. */
    public static Level STDOUT = new LogStdLevel("STDOUT", Level.INFO.intValue()+53);
    /** Level for STDERR activity  */
    public static Level STDERR = new LogStdLevel("STDERR", Level.INFO.intValue()+54);
     ...
     */
    private LogStdLevel(String name, int value) {
        super(name, value);
    }
