...
public class AlsConstraintSimulationPanel extends JPanel {
	...
	private ArrayList<AlsConstraintPanel> singleConstraintsListPanel;
	private JButton btnDisableAll;
	private JButton btnEnableAll;
	private JLabel lblChooseWhichConstraints;
	private JButton btndefault;

	public AlsConstraintSimulationPanel (TOCL2AlloyOption oclOptions,AppFrame frame)
	{		
		this();
	...
	public void setOCLOptionPane (TOCL2AlloyOption oclOptions, JFrame frame)
	{
		...
		{
			AlsConstraintPanel singleConstraint = new AlsConstraintPanel(ct,oclOptions.getConstraintType(ct),
	...
	public ArrayList<Integer> getScopesListSelected()
	{
		...
		for(AlsConstraintPanel singleCt: singleConstraintsListPanel)
		{
	 ...
	 */
	public AlsConstraintSimulationPanel() 
	{
		...
		singleConstraintsListPanel = new ArrayList<AlsConstraintPanel>();
