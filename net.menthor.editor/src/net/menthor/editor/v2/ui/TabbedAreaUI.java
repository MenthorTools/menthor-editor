...
public class TabbedAreaUI {
	
	private TopTabbedPaneUI topPane = TopTabbedPaneUI.get();
	private BottomTabbedPaneUI bottomPane = BottomTabbedPaneUI.get();
	...
	private static class TabbedAreaLoader {
        private static final TabbedAreaUI INSTANCE = new TabbedAreaUI();
    }	
	public static TabbedAreaUI get() { 
		return TabbedAreaLoader.INSTANCE; 
	}	
    private TabbedAreaUI() {
    	super();
...
//    	}		    	
    ...
    public TopTabbedPaneUI editorsPane(){ return topPane; }
}
