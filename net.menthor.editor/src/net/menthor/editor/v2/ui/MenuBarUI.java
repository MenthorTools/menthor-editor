...
public class MenuBarUI extends GenericMenuBar {
	...
	private static class GUIMenuBarLoader {
        private static final MenuBarUI INSTANCE = new MenuBarUI();
    }	
	public static MenuBarUI get() { 
...
//		window.setVisible(true);
		...
		SwingUtilities.updateComponentTreeUI(MenuBarUI.get());
	}
