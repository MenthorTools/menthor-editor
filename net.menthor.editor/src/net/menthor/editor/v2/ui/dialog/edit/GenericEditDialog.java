...
public class GenericEditDialog extends JDialog {
	...
	public GenericEditDialog(final JDialog parent, boolean modal){
		super(parent, modal);
		buildUI();
		
	}
	
	public GenericEditDialog(final JFrame parent, boolean modal){
		super(parent, modal);	
		buildUI();		
	}	
