...
import net.menthor.editor.v2.element.PropertyElement;
import net.menthor.editor.v2.ui.icon.IconMap;
import net.menthor.editor.v2.ui.icon.IconType;

public class PropertyListEditDialog extends JDialog {
	...
	public static void open(JFrame parent, Component componentToUpdate, String featureName, Element element, OntoUMLParser refparser){
		try {			
			PropertyListEditDialog dialog = new PropertyListEditDialog(parent, componentToUpdate, element, refparser, featureName);
	...
	public PropertyListEditDialog(JFrame owner, Component componentToUpdate, Element element, OntoUMLParser refparser, String featureName){
		super(owner);
		initData(componentToUpdate, element,refparser,featureName);
		initGUI();		
	}
	
	public PropertyListEditDialog(JDialog owner, Component componentToUpdate, Element element, OntoUMLParser refparser, String featureName){		
		super(owner);
		initData(componentToUpdate, element,refparser,featureName);
		initGUI();		
	}
	
	public PropertyListEditDialog(){		
		initGUI();
	}
