...
public class CursorUIController  {
	...
	TopTabbedPaneUI pane = TopTabbedPaneUI.get();
	
	// -------- Lazy Initialization

	private static class CursorLoader {
        private static final CursorUIController INSTANCE = new CursorUIController();
    }	
	public static CursorUIController get() { 
		return CursorLoader.INSTANCE; 
	}	
    private CursorUIController() {
