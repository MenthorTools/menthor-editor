...
public class BrowserUIController {

	BrowserUI browser = BrowserUI.get();
	
	// -------- Lazy Initialization
	
	private static class BrowserLoader {
        private static final BrowserUIController INSTANCE = new BrowserUIController();
    }	
	public static BrowserUIController get() { 
		return BrowserLoader.INSTANCE; 
	}	
    private BrowserUIController() {
