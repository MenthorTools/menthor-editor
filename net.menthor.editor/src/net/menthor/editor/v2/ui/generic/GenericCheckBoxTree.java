...
public abstract class GenericCheckBoxTree extends CheckboxTree {
	...
	protected GenericCheckBoxTree(final ICommandListener listener, DefaultMutableTreeNode rootNode){
		this(rootNode);
	...
	/**Constructor */
	protected GenericCheckBoxTree(DefaultMutableTreeNode rootNode){
		super(rootNode);
