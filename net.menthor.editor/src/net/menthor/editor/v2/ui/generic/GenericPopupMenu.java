...
public abstract class GenericPopupMenu <T> extends JPopupMenu implements ActionListener{
	...
	/** create and configure a menu item */
	public JMenuItem createMenuItem(String name, IconType icontype, CommandType command, boolean isAdd){
	...
	public void configureMenuItem(String name, IconType icontype, CommandType command, boolean isAdd, JMenuItem item) {
