...
import net.menthor.editor.draw.DiagramOperations;
...
import net.menthor.editor.draw.MoveOperation;
import net.menthor.editor.draw.MultiLineLabel;
import net.menthor.editor.draw.Node;
import net.menthor.editor.draw.NodeChangeListener;
import net.menthor.editor.draw.NullElement;
import net.menthor.editor.draw.RectilinearConnection;
import net.menthor.editor.draw.Scaling;
import net.menthor.editor.draw.SimpleConnection;
import net.menthor.editor.draw.SimpleLabel;
import net.menthor.editor.draw.TreeConnection;
import net.menthor.editor.draw.DrawingContext.FontType;
...
import net.menthor.editor.ui.diagram.commands.ConvertConnectionTypeCommand;
...
import net.menthor.editor.ui.diagram.commands.EditConnectionPointsCommand;
import net.menthor.editor.ui.diagram.commands.MoveElementCommand;
import net.menthor.editor.ui.diagram.commands.ResetConnectionPointsCommand;
import net.menthor.editor.ui.diagram.commands.ResizeElementCommand;
import net.menthor.editor.ui.diagram.commands.SetConnectionNavigabilityCommand;
...
import net.menthor.editor.umldraw.structure.BaseConnection;
