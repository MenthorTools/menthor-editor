...
import net.menthor.editor.draw.MultiSelection;
import net.menthor.editor.draw.NodeSelection;
import net.menthor.editor.draw.NullElement;
import net.menthor.editor.draw.NullSelection;
import net.menthor.editor.draw.RubberbandSelector;
import net.menthor.editor.draw.Selection;
import net.menthor.editor.umldraw.shared.UmlConnectionSelection;
import net.menthor.editor.umldraw.shared.UmlDiagramElement;
