...
public class OCLCellRenderer extends CompletionCellRenderer {
	...
	protected void prepareForTemplateCompletion(JList list, TemplateCompletion tc, int index, boolean selected, boolean hasFocus) 
	{
		...
		if (tc.getDefinitionString().equals("if-then-else")||
		   ...
		   {
			setIcon(new ImageIcon(OCLCellRenderer.class.getResource("/net/menthor/ocl/editor/icons/expression.gif")));
		}else
		...
		if (tc.getDefinitionString().equals("=")||
			...
			setIcon(new ImageIcon(OCLCellRenderer.class.getResource("/net/menthor/ocl/editor/icons/operation.gif")));
		}else
		
		if (tc.getDefinitionString().equals("allInstances")){
			setIcon(new ImageIcon(OCLCellRenderer.class.getResource("/net/menthor/ocl/editor/icons/allInstances.gif")));
		} else 
		...
		if (tc.getDefinitionString().contains("Property")){
			setIcon(new ImageIcon(OCLCellRenderer.class.getResource("/net/menthor/ocl/editor/icons/property.gif")));
		}else
		...
		{
			setIcon(new ImageIcon(OCLCellRenderer.class.getResource("/net/menthor/ocl/editor/icons/class.png")));
		}
