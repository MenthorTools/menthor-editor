...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Allen Relation</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see net.menthor.metamodel.ontouml.OntoumlPackage#getAllenRelation()
 * @model
 * @generated
 */
public enum AllenRelation implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Allen Relation</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final AllenRelation[] VALUES_ARRAY =
		new AllenRelation[] {
			STARTS,
			PRECEDES,
			EQUALS,
	...
	/**
	 * A public read-only list of all the '<em><b>Allen Relation</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<AllenRelation> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Allen Relation</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static AllenRelation get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			AllenRelation result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Allen Relation</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static AllenRelation getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			AllenRelation result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Allen Relation</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static AllenRelation get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private AllenRelation(int value, String name, String literal) {
		this.value = value;
		this.name = name;
