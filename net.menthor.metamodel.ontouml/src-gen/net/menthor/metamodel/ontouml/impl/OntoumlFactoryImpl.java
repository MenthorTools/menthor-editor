...
public class OntoumlFactoryImpl extends EFactoryImpl implements OntoumlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case OntoumlPackage.HIGH_ORDER_CLASS: return createHighOrderClass();
			...
			case OntoumlPackage.MATERIAL_RELATIONSHIP: return createMaterialRelationship();
			case OntoumlPackage.GENERALIZATION_SET: return createGeneralizationSet();
			case OntoumlPackage.PRIMITIVE_DATA_TYPE: return createPrimitiveDataType();
			case OntoumlPackage.ENUMERATION: return createEnumeration();
			case OntoumlPackage.COMPLEX_DATA_TYPE: return createComplexDataType();
			case OntoumlPackage.DATA_TYPE_ATTRIBUTE: return createDataTypeAttribute();
			default:
	 ...
	 * @generated
	 */
	public MaterialRelationship createMaterialRelationship() {
		MaterialRelationshipImpl materialRelationship = new MaterialRelationshipImpl();
