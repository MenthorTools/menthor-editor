 ...
 * <ul>
 *   <li>{@link net.menthor.metamodel.ontouml.impl.HighOrderClassImpl#getContainer_ <em>Container </em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HighOrderClassImpl extends NamedElementImpl implements HighOrderClass {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return OntoumlPackage.Literals.HIGH_ORDER_CLASS;
	}
	...
	public net.menthor.metamodel.ontouml.Container getContainer_() {
		if (eContainerFeatureID() != OntoumlPackage.HIGH_ORDER_CLASS__CONTAINER_) return null;
	...
	public NotificationChain basicSetContainer_(net.menthor.metamodel.ontouml.Container newContainer_, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newContainer_, OntoumlPackage.HIGH_ORDER_CLASS__CONTAINER_, msgs);
		return msgs;
	}
	...
	public void setContainer_(net.menthor.metamodel.ontouml.Container newContainer_) {
		if (newContainer_ != eInternalContainer() || (eContainerFeatureID() != OntoumlPackage.HIGH_ORDER_CLASS__CONTAINER_ && newContainer_ != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, OntoumlPackage.HIGH_ORDER_CLASS__CONTAINER_, newContainer_, newContainer_));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OntoumlPackage.HIGH_ORDER_CLASS__CONTAINER_:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == PackageableElement.class) {
			switch (derivedFeatureID) {
				case OntoumlPackage.HIGH_ORDER_CLASS__CONTAINER_: return OntoumlPackage.PACKAGEABLE_ELEMENT__CONTAINER_;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == PackageableElement.class) {
			switch (baseFeatureID) {
				case OntoumlPackage.PACKAGEABLE_ELEMENT__CONTAINER_: return OntoumlPackage.HIGH_ORDER_CLASS__CONTAINER_;
				default: return -1;
			}
		}
