 ...
 * <ul>
 *   <li>{@link net.menthor.metamodel.ontouml.impl.DomainImpl#getDimensions <em>Dimensions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DomainImpl extends StructureImpl implements Domain {
	/**
	...
	public EList<Dimension> getDimensions() {
		if (dimensions == null) {
			dimensions = new EObjectWithInverseResolvingEList<Dimension>(Dimension.class, this, OntoumlPackage.DOMAIN__DIMENSIONS, OntoumlPackage.DIMENSION__OWNER_DOMAIN);
		}
		return dimensions;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case OntoumlPackage.DOMAIN__DIMENSIONS:
