...
import net.menthor.ontouml2alloy.scenarios.AntiRigidityScenario;
import net.menthor.ontouml2alloy.scenarios.AssociationDepthScenario;
import net.menthor.ontouml2alloy.scenarios.AssociationMultiplicityScenario;
import net.menthor.ontouml2alloy.scenarios.AssociationVariabilityScenario;
import net.menthor.ontouml2alloy.scenarios.ComparisonScenario;
import net.menthor.ontouml2alloy.scenarios.InstantiationScenario;
import net.menthor.ontouml2alloy.scenarios.ParagraphType;
import net.menthor.ontouml2alloy.scenarios.Scenario;
import net.menthor.ontouml2alloy.scenarios.SegmentSizeScenario;
import net.menthor.ontouml2alloy.scenarios.SegmentVariabilityScenario;
