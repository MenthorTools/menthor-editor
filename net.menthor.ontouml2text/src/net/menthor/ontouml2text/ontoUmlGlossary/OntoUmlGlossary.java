package net.menthor.ontouml2text.ontoUmlGlossary;
...
import net.menthor.ontouml2text.descriptionSpaceGenerator.DescriptionSpaceGenerator;
import net.menthor.ontouml2text.glossaryExporter.HtmlGlossaryExporter;
import net.menthor.ontouml2text.stringGenerator.PortugueseDictionary;
import net.menthor.ontouml2text.stringGenerator.PortugueseLanguageAdaptor;
import net.menthor.ontouml2text.stringGenerator.StringGenerator;
