...
public class EnglishLanguageAdaptor extends LanguageAdaptor {

	public EnglishLanguageAdaptor(Dictionary dictionary) {
		super(dictionary);
	}
	...
	@Override
	protected String processMaterialPattern(DescriptionPattern pattern,
			DescriptionPattern previousPattern, String parcialDescription) {
		// TODO Auto-generated method stub
		return null;
	}
