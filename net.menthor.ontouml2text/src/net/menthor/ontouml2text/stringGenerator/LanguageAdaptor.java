...
import net.menthor.ontouml2text.stringGenerator.patterns.CharacterizationPattern;
import net.menthor.ontouml2text.stringGenerator.patterns.DescriptionPattern;
...
import net.menthor.ontouml2text.stringGenerator.patterns.unaryPatterns.AttributePattern;
import net.menthor.ontouml2text.stringGenerator.patterns.unaryPatterns.TopPattern;
...
//			System.out.println(patterns.toString().replace("br.ufes.inf.nemo.ontouml2text.stringGenerator.patterns.", ""));
			...
			return describedCategory.getUserDescription().replace("Descri��o:", "");
		}
	}
