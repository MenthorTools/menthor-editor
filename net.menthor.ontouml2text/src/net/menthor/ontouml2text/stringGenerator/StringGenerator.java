...
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.*;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.*;
import net.menthor.ontouml2text.glossaryExporter.*;
