package net.menthor.ontouml2text.descriptionSpaceGenerator;
...
import net.menthor.ontouml2text.descriptionSpace.DescriptionFunction;
import net.menthor.ontouml2text.descriptionSpace.DescriptionSpace;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.Category;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.Collective;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.Kind;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.Mixin;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.Mode;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.Phase;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.Quantity;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.Relator;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.Role;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.RoleMixin;
import net.menthor.ontouml2text.descriptionSpace.descriptionCategories.Subkind;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.Characterization;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.ComponentOf;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.Formal;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.Generalization;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.GeneralizationSet;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.Material;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.Mediation;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.MemberOf;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.SubcollectiveOf;
import net.menthor.ontouml2text.descriptionSpace.descriptionFunctions.SubquantityOf;
