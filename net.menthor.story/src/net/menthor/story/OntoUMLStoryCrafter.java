...
public class OntoUMLStoryCrafter {
	...
	private static void teste1() throws IOException{
		...
		//aqui vou fazer um exemplo de execu��o dessa interface. O usu�rio cria duas instancias, dois mundos, uma rela��o entre elas no segundo mundo.
		...
		System.out.println(OntoUMLStoryCrafter.getAuxPredicates());//por enquanto est� vazio
