...
;#define MENTHOR_VERSION "1.0"
#define MENTHOR_VERSION "2.3.4.5"
...
[Files]
Source: "{#MyAppExeName}{#MENTHOR_VERSION}.exe"; DestDir: "{app}"; 
...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}{#MENTHOR_VERSION}.exe"; IconFilename:"{app}\{#MyIcon}"; Tasks: startmenuicon 
;Name: "{app}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; IconFilename:"{app}\{#MyIcon}"; 
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}{#MENTHOR_VERSION}.exe"; IconFilename:"{app}\{#MyIcon}"; Tasks: desktopicon 
...
Root: HKCR; Subkey: "{#MyKey}\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#MyAppExeName}{#MENTHOR_VERSION}.exe"" ""%1"""
...
begin
  ...
  begin
    if StrToFloat(menthorVersion) <> {#MENTHOR_VERSION} then        
    begin
