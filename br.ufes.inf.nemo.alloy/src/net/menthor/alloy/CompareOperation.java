 ...
 * <ul>
 *   <li>{@link net.menthor.alloy.CompareOperation#getLeftExpression <em>Left Expression</em>}</li>
 *   <li>{@link net.menthor.alloy.CompareOperation#getRightExpression <em>Right Expression</em>}</li>
 *   <li>{@link net.menthor.alloy.CompareOperation#getOperator <em>Operator</em>}</li>
 *   <li>{@link net.menthor.alloy.CompareOperation#isNegation <em>Negation</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.menthor.alloy.AlloyPackage#getCompareOperation()
 * @model
 * @generated
 */
public interface CompareOperation extends Expression {
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getCompareOperation_LeftExpression()
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.CompareOperation#getLeftExpression <em>Left Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getCompareOperation_RightExpression()
	 * @model containment="true" required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.CompareOperation#getRightExpression <em>Right Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link net.menthor.alloy.CompareOperator}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getCompareOperation_Operator()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.CompareOperation#getOperator <em>Operator</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getCompareOperation_Negation()
	 * @model required="true"
	 * @generated
	 */
	boolean isNegation();
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.CompareOperation#isNegation <em>Negation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
