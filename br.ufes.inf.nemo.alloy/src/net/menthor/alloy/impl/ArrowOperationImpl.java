 ...
 * <ul>
 *   <li>{@link net.menthor.alloy.impl.ArrowOperationImpl#getLeftMultiplicity <em>Left Multiplicity</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.ArrowOperationImpl#getRightMultiplicity <em>Right Multiplicity</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.ArrowOperationImpl#getLeftExpression <em>Left Expression</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.ArrowOperationImpl#getRightExpression <em>Right Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
