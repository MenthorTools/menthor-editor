 ...
 * <ul>
 *   <li>{@link net.menthor.alloy.impl.SignatureDeclarationImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.SignatureDeclarationImpl#getMultiplicity <em>Multiplicity</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.SignatureDeclarationImpl#getRelation <em>Relation</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.SignatureDeclarationImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.SignatureDeclarationImpl#isExists <em>Exists</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.SignatureDeclarationImpl#getInheritance <em>Inheritance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
