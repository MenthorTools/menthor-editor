 ...
 * <ul>
 *   <li>{@link net.menthor.alloy.CommandDeclaration#getScope <em>Scope</em>}</li>
 *   <li>{@link net.menthor.alloy.CommandDeclaration#getBlock <em>Block</em>}</li>
 *   <li>{@link net.menthor.alloy.CommandDeclaration#getAssertion <em>Assertion</em>}</li>
 *   <li>{@link net.menthor.alloy.CommandDeclaration#getPredicate <em>Predicate</em>}</li>
 *   <li>{@link net.menthor.alloy.CommandDeclaration#isIsRun <em>Is Run</em>}</li>
 *   <li>{@link net.menthor.alloy.CommandDeclaration#isIsCheck <em>Is Check</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.menthor.alloy.AlloyPackage#getCommandDeclaration()
 * @model
 * @generated
 */
public interface CommandDeclaration extends Paragraph {
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getCommandDeclaration_Scope()
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.CommandDeclaration#getScope <em>Scope</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setBlock(Block)
	 * @see net.menthor.alloy.AlloyPackage#getCommandDeclaration_Block()
	 * @model
	 * @generated
	 */
	Block getBlock();
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.CommandDeclaration#getBlock <em>Block</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getCommandDeclaration_Assertion()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.CommandDeclaration#getAssertion <em>Assertion</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getCommandDeclaration_Predicate()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.CommandDeclaration#getPredicate <em>Predicate</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getCommandDeclaration_IsRun()
	 * @model required="true"
	 * @generated
	 */
	boolean isIsRun();
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.CommandDeclaration#isIsRun <em>Is Run</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getCommandDeclaration_IsCheck()
	 * @model required="true"
	 * @generated
	 */
	boolean isIsCheck();
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.CommandDeclaration#isIsCheck <em>Is Check</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
