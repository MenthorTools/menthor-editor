 ...
 * <ul>
 *   <li>{@link net.menthor.alloy.Inheritance#getSupertype <em>Supertype</em>}</li>
 *   <li>{@link net.menthor.alloy.Inheritance#isIsSubset <em>Is Subset</em>}</li>
 *   <li>{@link net.menthor.alloy.Inheritance#isIsExtension <em>Is Extension</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.menthor.alloy.AlloyPackage#getInheritance()
 * @model
 * @generated
 */
public interface Inheritance extends EObject {
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getInheritance_Supertype()
	 * @model required="true"
	 * @generated
	 */
	String getSupertype();
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.Inheritance#getSupertype <em>Supertype</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getInheritance_IsSubset()
	 * @model required="true"
	 * @generated
	 */
	boolean isIsSubset();
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.Inheritance#isIsSubset <em>Is Subset</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getInheritance_IsExtension()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.Inheritance#isIsExtension <em>Is Extension</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
