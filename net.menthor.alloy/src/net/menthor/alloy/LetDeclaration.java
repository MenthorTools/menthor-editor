 ...
 * <ul>
 *   <li>{@link net.menthor.alloy.LetDeclaration#getEqualExpression <em>Equal Expression</em>}</li>
 *   <li>{@link net.menthor.alloy.LetDeclaration#getBlock <em>Block</em>}</li>
 *   <li>{@link net.menthor.alloy.LetDeclaration#getName <em>Name</em>}</li>
 *   <li>{@link net.menthor.alloy.LetDeclaration#getBarExpression <em>Bar Expression</em>}</li>
 *   <li>{@link net.menthor.alloy.LetDeclaration#isHasBlock <em>Has Block</em>}</li>
 *   <li>{@link net.menthor.alloy.LetDeclaration#isHasExpression <em>Has Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.menthor.alloy.AlloyPackage#getLetDeclaration()
 * @model
 * @generated
 */
public interface LetDeclaration extends Expression {
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getLetDeclaration_EqualExpression()
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.LetDeclaration#getEqualExpression <em>Equal Expression</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setBlock(Block)
	 * @see net.menthor.alloy.AlloyPackage#getLetDeclaration_Block()
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.LetDeclaration#getBlock <em>Block</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getLetDeclaration_Name()
	 * @model required="true"
	 * @generated
	 */
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getLetDeclaration_BarExpression()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.LetDeclaration#getBarExpression <em>Bar Expression</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getLetDeclaration_HasBlock()
	 * @model required="true"
	 * @generated
	 */
	boolean isHasBlock();
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.LetDeclaration#isHasBlock <em>Has Block</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.menthor.alloy.AlloyPackage#getLetDeclaration_HasExpression()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link net.menthor.alloy.LetDeclaration#isHasExpression <em>Has Expression</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
