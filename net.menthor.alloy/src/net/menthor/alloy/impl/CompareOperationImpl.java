 ...
 * <ul>
 *   <li>{@link net.menthor.alloy.impl.CompareOperationImpl#getLeftExpression <em>Left Expression</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.CompareOperationImpl#getRightExpression <em>Right Expression</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.CompareOperationImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.CompareOperationImpl#isNegation <em>Negation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
