 ...
 * <ul>
 *   <li>{@link net.menthor.alloy.impl.CommandDeclarationImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.CommandDeclarationImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.CommandDeclarationImpl#getAssertion <em>Assertion</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.CommandDeclarationImpl#getPredicate <em>Predicate</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.CommandDeclarationImpl#isIsRun <em>Is Run</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.CommandDeclarationImpl#isIsCheck <em>Is Check</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommandDeclarationImpl extends ParagraphImpl implements CommandDeclaration {
	...
	public String toString() {
		...
		if(isRun) 
		{
			...
			result.append("run "+name+" { } for "+genScope.getScopeSize());
