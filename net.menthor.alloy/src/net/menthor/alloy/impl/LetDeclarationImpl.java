 ...
 * <ul>
 *   <li>{@link net.menthor.alloy.impl.LetDeclarationImpl#getEqualExpression <em>Equal Expression</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.LetDeclarationImpl#getBlock <em>Block</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.LetDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.LetDeclarationImpl#getBarExpression <em>Bar Expression</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.LetDeclarationImpl#isHasBlock <em>Has Block</em>}</li>
 *   <li>{@link net.menthor.alloy.impl.LetDeclarationImpl#isHasExpression <em>Has Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
