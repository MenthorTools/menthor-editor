...
import net.menthor.alloy.ArrowOperation;
import net.menthor.alloy.AssertionDeclaration;
import net.menthor.alloy.BinaryOperation;
import net.menthor.alloy.BinaryOperator;
import net.menthor.alloy.Block;
import net.menthor.alloy.CommandDeclaration;
import net.menthor.alloy.CompareOperation;
import net.menthor.alloy.CompareOperator;
import net.menthor.alloy.ComprehensionExpression;
import net.menthor.alloy.Constant;
import net.menthor.alloy.ConstantExpression;
import net.menthor.alloy.Declaration;
import net.menthor.alloy.DetailedScope;
import net.menthor.alloy.DisjointExpression;
import net.menthor.alloy.EnumDeclaration;
import net.menthor.alloy.Expression;
import net.menthor.alloy.ExternalReference;
import net.menthor.alloy.FactDeclaration;
import net.menthor.alloy.FunctionDeclaration;
import net.menthor.alloy.FunctionInvocation;
import net.menthor.alloy.GenericScope;
import net.menthor.alloy.ImpliesOperation;
import net.menthor.alloy.ImporterModule;
import net.menthor.alloy.Inheritance;
import net.menthor.alloy.LetDeclaration;
import net.menthor.alloy.ModuleImportation;
import net.menthor.alloy.Multiplicity;
import net.menthor.alloy.Paragraph;
import net.menthor.alloy.ParametrizedModule;
...
import net.menthor.alloy.ScopeSpecification;
import net.menthor.alloy.Scopeable;
import net.menthor.alloy.SignatureDeclaration;
import net.menthor.alloy.SignatureParameter;
import net.menthor.alloy.SignatureReference;
import net.menthor.alloy.UnaryOperation;
import net.menthor.alloy.UnaryOperator;
...
public class AlloyPackageImpl extends EPackageImpl implements AlloyPackage {
	 ...
	 * @see net.menthor.alloy.AlloyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
